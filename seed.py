...
DOCTORS = [
    dict(
        ...
        photo_url="https://images.pexels.com/photos/5738735/pexels-photo-5738735.jpeg?auto=compress&cs=tinysrgb&w=600",
    ),  # senior South Asian clinician — founder
    dict(
        ...
        photo_url="https://images.pexels.com/photos/37146800/pexels-photo-37146800.jpeg?auto=compress&cs=tinysrgb&w=600",  # South Asian dentist, pink scrubs
    ),
    dict(
        ...
        photo_url="https://images.pexels.com/photos/6762866/pexels-photo-6762866.jpeg?auto=compress&cs=tinysrgb&w=600",
    ),
    dict(
...
SERVICES = [
    ...
    dict(name="Orthodontics", slug="orthodontics", icon_name="braces", display_order=4,
         ...
         image_url="https://images.unsplash.com/photo-1620331311520-246422fd82f9?w=800&q=80&auto=format&fit=crop"),
...
TESTIMONIALS = [
    dict(patient_name="Sana Malik", treatment="Porcelain Veneers", rating=5, display_order=1,
         ...
         patient_photo_url="https://images.pexels.com/photos/20382106/pexels-photo-20382106.jpeg?auto=compress&cs=tinysrgb&w=200"),
    dict(patient_name="Usman Tariq", treatment="Dental Implants", rating=5, display_order=2,
         ...
         patient_photo_url="https://images.pexels.com/photos/29586709/pexels-photo-29586709.jpeg?auto=compress&cs=tinysrgb&w=200"),
    dict(patient_name="Hira Sheikh", treatment="Clear Aligners", rating=5, display_order=3,
         ...
         patient_photo_url="https://images.pexels.com/photos/13195217/pexels-photo-13195217.jpeg?auto=compress&cs=tinysrgb&w=200"),
    dict(patient_name="Fahad Chaudhry", treatment="Root Canal Treatment", rating=5, display_order=4,
         ...
         patient_photo_url="https://images.pexels.com/photos/7902122/pexels-photo-7902122.jpeg?auto=compress&cs=tinysrgb&w=200"),
    dict(patient_name="Zara Iqbal", treatment="Smile Makeover", rating=5, display_order=5,
         ...
         patient_photo_url="https://images.pexels.com/photos/35234681/pexels-photo-35234681.jpeg?auto=compress&cs=tinysrgb&w=200"),
    dict(patient_name="Hamza Qureshi", treatment="Emergency Dental Care", rating=5, display_order=6,
         ...
         patient_photo_url="https://images.pexels.com/photos/16887085/pexels-photo-16887085.jpeg?auto=compress&cs=tinysrgb&w=200"),
]

GALLERY_IMAGES = [
    dict(title="Veneer smile makeover", category="before-after", display_order=1, caption="8 upper porcelain veneers · 2 visits",
         before_image_url="https://images.pexels.com/photos/16430835/pexels-photo-16430835.jpeg?auto=compress&cs=tinysrgb&w=800",
         after_image_url="https://images.pexels.com/photos/20301626/pexels-photo-20301626.jpeg?auto=compress&cs=tinysrgb&w=800"),
    dict(title="Full-arch implants", category="before-after", display_order=2, caption="Fixed bridge on 6 implants",
         before_image_url="https://images.pexels.com/photos/20301626/pexels-photo-20301626.jpeg?auto=compress&cs=tinysrgb&w=800",
         after_image_url="https://images.pexels.com/photos/16430835/pexels-photo-16430835.jpeg?auto=compress&cs=tinysrgb&w=800"),
    dict(title="Pediatric sealants", category="facility", display_order=3, caption="Gentle first visit for a 5 year old",
         before_image_url="https://images.pexels.com/photos/8224659/pexels-photo-8224659.jpeg?auto=compress&cs=tinysrgb&w=800",
         after_image_url="https://images.pexels.com/photos/8224633/pexels-photo-8224633.jpeg?auto=compress&cs=tinysrgb&w=800"),
    dict(title="In-clinic whitening", category="before-after", display_order=4, caption="8 shades brighter · 60 minutes",
         before_image_url="https://images.pexels.com/photos/8224633/pexels-photo-8224633.jpeg?auto=compress&cs=tinysrgb&w=800",
         after_image_url="/static/images/hero-dental-care.jpg"),
    dict(title="Minimal-prep veneers", category="before-after", display_order=5, caption="Natural translucency, no grinding",
         before_image_url="https://images.pexels.com/photos/16430835/pexels-photo-16430835.jpeg?auto=compress&cs=tinysrgb&w=800",
         after_image_url="https://images.pexels.com/photos/8224659/pexels-photo-8224659.jpeg?auto=compress&cs=tinysrgb&w=800"),
    dict(title="Digital diagnostics", category="facility", display_order=6, caption="3D scan-guided treatment planning",
         before_image_url="https://images.pexels.com/photos/4269688/pexels-photo-4269688.jpeg?auto=compress&cs=tinysrgb&w=800",
         after_image_url="https://images.pexels.com/photos/6502746/pexels-photo-6502746.jpeg?auto=compress&cs=tinysrgb&w=800"),
]
...
BLOG_POSTS = [
    dict(title="5 Habits That Quietly Wreck Your Enamel", slug="habits-that-wreck-enamel", author="Dr. Ayesha Farooq",
         ...
         cover_image_url="https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=900&q=80&auto=format&fit=crop"),
