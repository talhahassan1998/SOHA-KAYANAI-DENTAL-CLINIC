...
GALLERY_IMAGES = [
    dict(title="Veneer smile makeover", category="before-after", display_order=1, caption="8 upper porcelain veneers · 2 visits",
         ...
         after_image_url="https://images.unsplash.com/photo-1606811971618-4486d14f3f99?w=800&q=80&auto=format&fit=crop"),
    ...
    dict(title="In-clinic whitening", category="before-after", display_order=4, caption="8 shades brighter · 60 minutes",
         before_image_url="https://images.unsplash.com/photo-1620331311520-246422fd82f9?w=800&q=80&auto=format&fit=crop",
